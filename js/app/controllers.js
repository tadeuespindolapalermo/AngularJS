...
.controller("indexController",function ($scope) {
	$scope.titulo = "AngularJS e Materialize - Home";
	$scope.alunos = [
	...
	var media = function (Aluno) {
		...
		// toFixed é um método Javascript para formatar a média com 2 casas decimais toFixed(2)
...
.controller("contatoController",function($scope) {
	$scope.titulo = "AngularJS e Materialize - Contato";
})